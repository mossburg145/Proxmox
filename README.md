...
<a href="https://github.com/mossburg145/Proxmox/blob/main/LICENSE"><img src="https://badgen.net/github/license/mossburg145/Proxmox" ></a> <a href="https://mossburg145.github.io/Proxmox/"><img src="https://badgen.net/github/checks/mossburg145/Proxmox/main/"></a> <a href="https://github.com/mossburg145/Proxmox/blob/main/CHANGELOG.MD"><img src="https://github.com/mossburg145/Proxmox/blob/main/misc/images/change.png?raw=true" height="21" /></a>🔸
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/post_install.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/kernel-clean.sh)"
```
____________________________________________________________________________________________ 
...
<p align="center"><img src="https://github.com/mossburg145/Proxmox/blob/main/misc/images/cpu.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/scaling-governor.sh)"
```
____________________________________________________________________________________________ 
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/update-lxcs.sh)"
```
____________________________________________________________________________________________ 
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/vm/haos_vm.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  4GB RAM - 50GB Storage - 2vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/podman_ha_container.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/ha-copy-data-podman.sh)"
 ```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/usb-passthrough.sh)" -s 106
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/podman_hacs.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/homeassistant.sh)"
```
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/ha-copy-data.sh)"
 ```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/hacs.sh)"
```
After install, reboot Home Assistant and **clear browser cache** then Add HACS integration.


⚙️ [**Update Menu**](https://raw.githubusercontent.com/mossburg145/Proxmox/main/misc/images/update-menu.png)
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/latest-update-menu.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/homebridge.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/esphome.sh)"
```
...
```yaml
 bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/nginx-proxy-manager.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/npm_update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/mqtt.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/node-red.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/node-red-themes.sh)"
```
...
<p align="center"><img src="https://mariadb.com/wp-content/webp-express/webp-images/doc-root/wp-content/themes/sage/dist/images/mariadb-logo-white.png.webp" alt="MariaDB"/><img src="https://raw.githubusercontent.com/mossburg145/Proxmox/main/misc/images/adminer_logo-cl.png" height="60"></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/mariadb.sh)"
```
...
apt update && apt upgrade -y
```
⚙️ [**Adminer**](https://raw.githubusercontent.com/mossburg145/Proxmox/main/misc/images/adminer.png) (formerly phpMinAdmin) is a full-featured database management tool
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/zigbee2mqtt.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  1GB RAM - 4GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/z2m-copy-data.sh)"
 ```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/zwavejs2mqtt.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  1GB RAM - 4GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/zwave-copy-data.sh)"
 ```
⚙️ **To Update Zwavejs2MQTT**

Run in the LXC Console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/zwavejs2mqtt-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/influxdb.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/grafana.sh)"
```
...
<p align="center"><img src="https://raw.githubusercontent.com/mossburg145/Proxmox/main/misc/images/docker.png" height="100"/></p>

<h1 align="center" id="heading"> Docker LXC </h1>
<h3 align="center"> With Selectable Storage Drivers & Add Portainer/Docker Compose Option</h3>

To create a new Proxmox Docker LXC, run the following in the Proxmox Shell (V2).

```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/docker.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/debian.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/ubuntu.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/unifi.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/unifi-update.sh)"
```
____________________________________________________________________________________________ 
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/omada.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/plex_container.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  2GB RAM - 8GB Storage - 2vCPU ⚡</h3>
...
Run in the Proxmox Shell
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/pms-copy-data.sh)"
 ```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/jellyfin_container.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  2GB RAM - 8GB Storage - 2vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/pihole.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  512MiB RAM - 2GB Storage - 1vCPU ⚡</h3>
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/technitiumdns.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/technitiumdns-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/adguard.sh)"
```
...
<p align="center"><img src="https://github.com/mossburg145/Proxmox/blob/main/misc/images/heimdall.png?raw=true" height="100"/></p>
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/heimdalldashboard.sh)"
```
<h3 align="center" id="heading">⚡ Default Settings:  512MiB RAM - 2GB Storage - 1vCPU ⚡</h3>
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/heimdalldashboard-all-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/dashy.sh)"
```
...
Run in the LXC Console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/dashy-update.sh)"
```
...
<p align="center"><img src="https://github.com/mossburg145/Proxmox/blob/main/misc/images/photoprism.png?raw=true" height="100"/></p>
...
```
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/photoprism.sh)"
```
...
Run in the LXC Console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/photoprism-update.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/daemonsync.sh)"
```
...
```
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/motioneye.sh)"
```
...
To Install Webmin System Administration [(Screenshot)](https://raw.githubusercontent.com/mossburg145/Proxmox/main/misc/images/file-manager.png), ⚠️ run the following in the LXC console.

```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/webmin.sh)"
```
...
```
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/wireguard.sh)"
```
...
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/ct/vaultwarden.sh)"
```
...
Run in the LXC console
```yaml
bash -c "$(wget -qLO - https://github.com/mossburg145/Proxmox/raw/main/misc/vaultwarden-update.sh)"
```
